...
<tr><td><a href="<c:url value='/all/getallproducts/'></c:url>"><button class="btn btn-sm btn-active">BACK TO PREVIOUS PAGE</button></a></td><td><a href="<c:url value='#'></c:url>"><button class="btn btn-sm btn-active">ADD TO CART</button></a></td></tr>
</tbody>
</table>
</div>
</body>
